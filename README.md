...
* [Soybean Admin](https://github.com/honghuangdc/soybean-admin) ⭐ 14,878 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-13 - a beautiful vue admin template, based on Vue3 + Vite + Naive UI + TypeScript.
* [Naive UI Admin](https://github.com/jekip/naive-ui-admin) ⭐ 5,902 | 🐛 36 | 🌐 Vue | 📅 2026-01-19 - A free open source out-of-box UI solution for enterprise applications.
* [Vue Naive Admin](https://github.com/zclzone/vue-naive-admin) ⭐ 3,983 | 🐛 1 | 🌐 Vue | 📅 2026-07-21 - A lightweight vue admin template, base on Vue 3 + Vite + Pinia + Naive UI，free and elegant.
...
* [zmtlwzy-admin](https://github.com/zmtlwzy/zmtlwzy-admin) ⭐ 95 | 🐛 6 | 🌐 TypeScript | 📅 2023-05-28 - A free open source, original style admin template.
...
* [YummyAdmin](https://github.com/doroudi/YummyAdmin) ⭐ 66 | 🐛 12 | 🌐 Vue | 📅 2026-06-16 - 📈 Vue 3 admin panel template based on Vue3 + NaiveUI + Tailwind + Pinia + MSW + TS.
...
* [Apache DolphinScheduler](https://github.com/apache/dolphinscheduler) ⭐ 14,441 | 🐛 146 | 🌐 Java | 📅 2026-08-22 - A distributed and easy-to-extend visual workflow scheduler system.
...
* [naive-ui-components-plus](https://github.com/ChenyCHENYU/naive-ui-components) ⭐ 7 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-09 - A general business component library based on Naive-UI and Robot Admin, out-of-the-box with comprehensive documentation and clear examples.
...
* [xicons](https://github.com/07akioni/xicons) ⭐ 1,488 | 🐛 56 | 🌐 JavaScript | 📅 2025-11-16 - SVG icon integrated component Library.
