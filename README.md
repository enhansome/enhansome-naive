...
* [Soybean Admin](https://github.com/honghuangdc/soybean-admin) ⭐ 14,980 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-07 - a beautiful vue admin template, based on Vue3 + Vite + Naive UI + TypeScript.
* [Naive UI Admin](https://github.com/jekip/naive-ui-admin) ⭐ 5,908 | 🐛 36 | 🌐 Vue | 📅 2026-01-19 - A free open source out-of-box UI solution for enterprise applications.
...
* [zce/fearless](https://github.com/zce/fearless) ⭐ 1,309 | 🐛 16 | 🌐 TypeScript | 📅 2026-09-07 - A dashboard scaffolding based on Vue.js 3.x & TypeScript created by Vite.
* [Robot Admin](https://github.com/ChenyCHENYU/Robot_Admin) ⭐ 1,016 | 🐛 2 | 🌐 Vue | 📅 2026-09-09 - A modern, enterprise-grade, out-of-the-box, plugin-level multi-modal architecture admin management system.
...
* [Apache DolphinScheduler](https://github.com/apache/dolphinscheduler) ⭐ 14,462 | 🐛 129 | 🌐 Java | 📅 2026-09-09 - A distributed and easy-to-extend visual workflow scheduler system.
...
* [vitesse-modular-naiveui](https://github.com/arijs/vitesse-modular-naiveui) ⭐ 10 | 🐛 1 | 🌐 TypeScript | 📅 2022-12-06 - A modular template based on [Vitesse](https://github.com/antfu/vitesse) ⭐ 9,438 | 🐛 33 | 🌐 TypeScript | 📅 2026-02-25 with many features.
...
* [naive-ui-components-plus](https://github.com/ChenyCHENYU/naive-ui-components) ⭐ 7 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-09 - A general business component library based on Naive-UI and Robot Admin, out-of-the-box with comprehensive documentation and clear examples.
