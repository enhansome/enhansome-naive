...
* [Soybean Admin](https://github.com/honghuangdc/soybean-admin) ⭐ 14,926 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-13 - a beautiful vue admin template, based on Vue3 + Vite + Naive UI + TypeScript.
...
* [Vue Naive Admin](https://github.com/zclzone/vue-naive-admin) ⭐ 3,984 | 🐛 2 | 🌐 Vue | 📅 2026-08-29 - A lightweight vue admin template, base on Vue 3 + Vite + Pinia + Naive UI，free and elegant.
...
* [Robot Admin](https://github.com/ChenyCHENYU/Robot_Admin) ⭐ 1,015 | 🐛 2 | 🌐 Vue | 📅 2026-09-01 - A modern, enterprise-grade, out-of-the-box, plugin-level multi-modal architecture admin management system.
...
* [zmtlwzy-admin](https://github.com/zmtlwzy/zmtlwzy-admin) ⭐ 94 | 🐛 5 | 🌐 TypeScript | 📅 2023-05-28 - A free open source, original style admin template.
...
* [Apache DolphinScheduler](https://github.com/apache/dolphinscheduler) ⭐ 14,455 | 🐛 139 | 🌐 Java | 📅 2026-09-01 - A distributed and easy-to-extend visual workflow scheduler system.
...
* [naive-ui-components-plus](https://github.com/ChenyCHENYU/naive-ui-components) ⭐ 7 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-01 - A general business component library based on Naive-UI and Robot Admin, out-of-the-box with comprehensive documentation and clear examples.
...
* [vueuc](https://github.com/07akioni/vueuc) ⭐ 312 | 🐛 30 | 🌐 TypeScript | 📅 2026-08-19 - Utils Components for Vue.
