...
Please see [CONTRIBUTING.md](https://github.com/naive-ui/awesome-naive/blob/main/CONTRIBUTING.md) ⭐ 342 | 🐛 1 | 📅 2026-07-05.
...
* [Soybean Admin](https://github.com/honghuangdc/soybean-admin) ⭐ 14,919 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-13 - a beautiful vue admin template, based on Vue3 + Vite + Naive UI + TypeScript.
* [Naive UI Admin](https://github.com/jekip/naive-ui-admin) ⭐ 5,906 | 🐛 36 | 🌐 Vue | 📅 2026-01-19 - A free open source out-of-box UI solution for enterprise applications.
* [Vue Naive Admin](https://github.com/zclzone/vue-naive-admin) ⭐ 3,987 | 🐛 2 | 🌐 Vue | 📅 2026-08-29 - A lightweight vue admin template, base on Vue 3 + Vite + Pinia + Naive UI，free and elegant.
...
* [Robot Admin](https://github.com/ChenyCHENYU/Robot_Admin) ⭐ 1,015 | 🐛 2 | 🌐 Vue | 📅 2026-08-31 - A modern, enterprise-grade, out-of-the-box, plugin-level multi-modal architecture admin management system.
...
* [YummyAdmin](https://github.com/doroudi/YummyAdmin) ⭐ 67 | 🐛 12 | 🌐 Vue | 📅 2026-06-16 - 📈 Vue 3 admin panel template based on Vue3 + NaiveUI + Tailwind + Pinia + MSW + TS.
* [Dolphin Admin](https://github.com/dolphin-admin/vue-admin) ⭐ 66 | 🐛 23 | 🌐 Vue | 📅 2024-04-11 - A light-weight and elegant back-end management template based on Vue 3 + Vite + Naive UI + TypeScript + TailwindCSS.
* [Pear-Admin-Naive](https://github.com/pearadmin/pear-admin-naive) ⭐ 36 | 🐛 1 | 🌐 Vue | 📅 2022-05-21 - A free open source admin template, base on Typescript + Vue3(script setup) + Vite + Naive UI + umi-request(Fetch).
* [BetterNCM Elaina Theme](https://github.com/keiko233/elaina-theme-netease) ⭐ 32 | 🐛 2 | 🌐 Vue | 📅 2024-12-31 - A NetEase Cloud Music theme plugin, built on BetterNCM platform, utilizing Naive UI for the frontend UI.
* [Walnut Admin](https://github.com/Zhaocl1997/walnut-admin-client) ⭐ 1 | 🐛 0 | 🌐 Vue | 📅 2026-07-26 - A free open source fullstack admin template project based on Typescript. Vue3 + Vite + Naive UI + [Nestjs](https://nestjs.com/) + [mongodb](https://www.mongodb.com/).
...
* [Apache DolphinScheduler](https://github.com/apache/dolphinscheduler) ⭐ 14,455 | 🐛 139 | 🌐 Java | 📅 2026-08-31 - A distributed and easy-to-extend visual workflow scheduler system.
* [OpenDataV](https://github.com/AnsGoo/openDataV) ⭐ 1,364 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-15 - A cool drag and drop, low code data visualization framework Vue3 + Vite + TypeScript + Naive UI
* [My RIME](https://github.com/LibreService/my_rime) ⭐ 437 | 🐛 0 | 🌐 TypeScript | 📅 2024-07-19 - Online Chinese IME powered by RIME.
...
* [Aisen60/vant-theme](https://github.com/Aisen60/vant-theme) ⭐ 112 | 🐛 12 | 🌐 Vue | 📅 2026-08-29 - Online theme preview tool built on vant UI
...
* [naive-ui-components-plus](https://github.com/ChenyCHENYU/naive-ui-components) ⭐ 7 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-31 - A general business component library based on Naive-UI and Robot Admin, out-of-the-box with comprehensive documentation and clear examples.
...
* [xicons](https://github.com/07akioni/xicons) ⭐ 1,492 | 🐛 56 | 🌐 JavaScript | 📅 2025-11-16 - SVG icon integrated component Library.
* [vueuc](https://github.com/07akioni/vueuc) ⭐ 313 | 🐛 30 | 🌐 TypeScript | 📅 2026-08-19 - Utils Components for Vue.
...
* [vdirs](https://github.com/07akioni/vdirs) ⭐ 15 | 🐛 2 | 🌐 TypeScript | 📅 2023-03-06 - Helper directives for Vue.
* [naive-ui-intelligence](https://github.com/tu6ge/naive-ui-intelligence) ⭐ 15 | 🐛 0 | 🌐 TypeScript | 📅 2026-02-11 - Intelligence Code of Naive UI for VS Code.
* [vite-plugin-naive-ui-md](https://github.com/Volankey/vite-plugin-naive-ui-md) ⭐ 12 | 🐛 0 | 🌐 TypeScript | 📅 2022-12-30 - Markdown for Vite with Naive UI Styles.
* [naive-ui-snippets](https://github.com/JimFirst/naive-ui-snippets) ⭐ 7 | 🐛 2 | 🌐 JavaScript | 📅 2021-07-16 - Code Snippets of Naive UI for VS Code.
